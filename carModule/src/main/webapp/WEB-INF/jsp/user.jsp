...
<section class="hero">
    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-md-12">
                <a class="hero-brand" href="../../home.jsp" title="Home"><img alt="QD Logo"
...
<header id="header">
    <div class="container">
        ...
        <div id="logo" class="pull-left">
            <a href="../../index.jsp"><img src="assets/img/logo-nav.png" alt=""></a>
...
<main id="main">
    ...
    <table border="1">
        ...
        <form action="addCar" method="get">
            <button type="submit" class="btn btn-light mb-1">Add car</button>
        </form>
